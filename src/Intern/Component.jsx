...
const Component = () => {  
  return (
    <div className=''>
      ...
      <div className='bg-customColor text-white custom:flex custom:justify-center flex-col'>
          <div className=' bg-gradient-to-b from-gray-800 to-gray-900  flex flex-col  justify-center align-center ml-24 mr-24 '>
            ...
            <div className='max-w-xs mx-2 my-2   shadow-lg overflow-hidden bg-customColor2 relative'>
            <div className=" ">
              <img className='' src={Tic1} alt='' />
            </div>
             <hr className="border-t-2 border-dashed opacity-50 mr-6 ml-6 relative"/>
             <div className="absolute top-30 bg-gray-900 opacity-90 left-0 w-6 h-6  rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>
             <div className="absolute top-30 bg-gray-900 opacity-90 right-0 w-6 h-6  rounded-full transform translate-x-1/2 -translate-y-1/2"></div>
             <div className=''>
                <center className=' text-xl font-poppins text-base font-medium leading-7 mt-5 '>Las Vegas Aviators</center>
                  <div className='mt-2 mb-3 '>
                    <center className='text-sm'>OCT 15 | SUN | 4:30 PM </center> 
                    <center className='font-inter text-sm font-normal leading-5 text-center mt-2'>Las Vegas Ballpark, Las Vegas,<br /> Nevada </center>
                  </div>
          ...
          <div className='max-w-xs mx-2 my-2   shadow-lg overflow-hidden bg-customColor2 relative'>
            <div className=" ">
             ...
             <div className=''>
                <center className=' text-xl font-poppins text-base font-medium leading-7 mt-5 '>Sacramento River Cats</center>
                  <div className='mt-2 mb-3 '>
                    <center className='text-sm'>OCT 15 | SUN | 4:30 PM </center> 
                    <center className='font-inter text-sm font-normal leading-5 text-center mt-2'>Sutter Health Park, Sacramento, <br /> California </center>
                  </div>
                  <center><button className='bg-black text-white px-4 py-2 mb-2 mt-2'>Take Flight Collection</button></center>
             </div>
          </div>
           ...
           <div className='max-w-xs mx-1 my-2 shadow-lg overflow-hidden bg-customColor2 relative md:my-2 md:mx-2'>
            <div className=" ">
              <img className='' src={Tic1} alt='' />
            </div>
             <hr className="border-t-2 border-dashed opacity-50 mr-6 ml-6 relative"/>
