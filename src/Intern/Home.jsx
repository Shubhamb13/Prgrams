...
const Home = () => {
  return (
    <div className='Home'>
     ...
     <div className='bg-customColor text-white  p-8'>
        ...
        <div className='flex flex-wrap justify-center'>
          <div className='max-w-xs mx-2 my-2   shadow-lg overflow-hidden bg-customColor2'>
            ...
            <div className='p-3'>
              ...
              <div className='bg-customColor p-1 m-1 mt-4'>
